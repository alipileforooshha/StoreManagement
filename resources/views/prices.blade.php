...
<html lang="en">
    ...
    <body class="landing-body">
        ...
        <div class="d-flex bg-main-color p-3 m-navbar shadow">
            ...
            <a href="" class="text-white mx-4 fs-4">ثبت نام/ورود</a>
        </div>

        <div class="d-flex prices_section justify-content-around">

            <div class="d-flex flex-column shadow justify-content-center p-3 plan-item">
                <h2>پلن برنزی</h2>
